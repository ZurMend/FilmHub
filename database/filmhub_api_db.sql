...
-- Password: Admin1234 (se hasheara con PHP al ejecutar install.php)
-- ============================================
-- NOTA: Ejecuta install.php desde el navegador para insertar
-- el admin con password hasheado correctamente.
